...
import com.goorm.thelastsupper.reservation.service.ReservationService;
...
//    @PreAuthorize("hasRole('USER')")
    public ResponseEntity<ReservationResponse> cancelReservation(@PathVariable String historyId,
        ...
        log.info("예약 취소 요청 수신 - reservationId={}, slotId={}, accountId={}", historyId, slotId, accountId);
...
//    @PreAuthorize("hasRole('USER')")
    public ResponseEntity<ReservationResponse> modifyReservation(@PathVariable String historyId,
        ...
        log.info("예약 수정 요청 수신 - reservationId={}, accountId={}, slotId={}", historyId, accountId, request.slotId());
