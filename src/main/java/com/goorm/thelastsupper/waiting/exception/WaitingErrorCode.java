...
public enum WaitingErrorCode {
    ...
    WAITING_ALREADY_PAUSED(HttpStatus.BAD_REQUEST,"대기열이 이미 중단되어 있습니다."),
    WAITING_NOT_OPENED(HttpStatus.BAD_REQUEST, "대기열이 열려있지 않습니다."),
    WAITING_ALREADY_OPEN(HttpStatus.CONFLICT, "대기열이 이미 오픈되어 있습니다."),
    RESTAURANT_NOT_FOUND(HttpStatus.NOT_FOUND, "해당 매장을 찾을 수 없습니다."),
    WAITING_ALREADY_CLOSED(HttpStatus.BAD_REQUEST,"대기열이 이미 종료되었습니다.");
